...
一方面 IB 的游戏设计完全无视经典设计理论，几乎是反教科书式的，它的引导为零、学习成本极高、难度曲线离谱，另一方面 IB 则为上手之后的硬核玩家提供了相当深的游戏内容。在 IB 之前，我从未想过我玩 PvE 游戏的时间会超过 PvP 游戏的时间。

另外，名为《不可能的 Boss》，设计重心也确实放在了 Boss 上。作为首个带有英雄元素的 RTS 游戏的编辑器，大部分地图都将设计重点放在了玩家操控的英雄身上，开发者们对设计 Boss 并没有太大的兴趣。
...
IB 中药水是必需品，但又会在 Boss 战后消失，因此需要好好规划购买量，而不是无脑买满。简单的一个限制就带来了有深度的策略性，买少了会影响战斗，买多了会浪费钱，如今这一设计也可以在暗黑地牢之类的游戏中见到。四俩拨千斤的设计，虽然虚构层上好像没什么道理，为啥打完 Boss 药水会消失呢，不过玩家也并不会太质疑这种逻辑。
...
火焰之王，游戏的第一个 Boss，也是 IB 恶意最大、初见杀最多的的 Boss，完全反教科书设计的关卡，难上手，易精通。这一关作为门槛挡住了绝大多数的休闲玩家，筛选出了喜欢挑战的玩家
...
维拉之灵，IB 中最有代表性的 Boss 技能设计，初见杀，全体点名，

#### 暗影

来到三圣，Boss 难度又上了一个台阶，Boss 技能间隔缩短，经常会形成一些 Combo，考察玩家综合实力和处理意外的能力，如果队伍中有短板，在前五关可能还不明显，但在三圣一定会暴露无遗。

暗影的战术设计是打散玩家阵型、分而治之，通过灵魂毁灭、黑暗堕落、幽魂冥火打乱队伍阵型，再通过
暗影的诸多技能要求玩家集合在 Boss 附近：魂飘神荡（远了无法反制）、三鬼拍门、暗影分身（远了会分身）。
但另外一部分会打乱玩家

#### 寒冰

寒冰原本是第二个 Boss，最终的版本才和娜迦调换了位置，寒冰是个打消耗打资源的 Boss，技能以消耗和召唤为主，没有太多致命的技能。
