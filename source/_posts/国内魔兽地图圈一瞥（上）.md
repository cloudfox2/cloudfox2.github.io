...
![Zorrot Chen](https://i.loli.net/2021/04/04/pfSXOjVhY3vrg64.jpg)_《UI》_
...
- 🎉‎️‍✨ [淬火试炼](http://www.warchasersreforged.com)（本来是战争行者的域名）：魔兽重置版 mod，旨在提升重制版的画面和体验，也在做原版战役的重置。
...
> 每每向传说窥去，无数英雄交叠错至，传奇的碑文凛然排列，一个个名字背后雪藏一段段故事。

本文比我想象的还要花精力，主要是大部分内容都是 5 年以前的事了，跟考古似的，贴吧又删了很多贴子。只能先分段发布了，否则要搞到猴年马月了。

从 YDWE 到 w3x2lni；从物编到触发到 Jass 到 CJass、VJass、Zinc 到 lua 再到 Wurst；从 1.20 到 1.24 到 1.29 再到重置版；从浩方到妖妖再到网易。斗转星移、时代更替，魔兽地图圈的兴衰离不开社区大佬们的研究探索与共享精神，向他们致敬！
